...
Die \texttt{nodes}-Klausel beschreibt eine (nicht leere) Menge von Knoten, die im Graphfragment enthalten sein sollen. Die \texttt{nodes}-Klausel hat, abgesehen vom Schlüsselwort,  die gleiche Syntax wie die \texttt{node}-Klausel.
