...
\subsubsection{Rückgängig/Wiederherstellen: \texttt{undo} und \texttt{redo}}\label{befehl-undo}

Mit dem Befehl \texttt{undo} können zuvor ausgeführte Annotationsbefehle rückgängig gemacht werden.
Zu diesen Befehlen zählen diejenigen Befehle, die Knoten oder Kanten erstellen oder löschen sowie auch das Erstellen und Löschen von Sätzen, nicht jedoch arbeitsbereichsbezogene Befehle wie \texttt{add} oder \texttt{clear}.
Ein rückgängig gemachter Befehl kann mit \texttt{redo} erneut ausgeführt werden.
