...
First, you may decide whether the file should be stored in a compact JSON format.
...
Second, you can opt for saving the change log (cf. \ref{befehl-undo}), so that it stays available accross settings.
